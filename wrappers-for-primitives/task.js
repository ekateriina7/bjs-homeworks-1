...
let monthPay = restAmount * (((percent/100) / 12) + ((percent/100) / 12) / (Math.pow((1 + (percent/100 / 12)) , numberOfMonths) - 1));

let totalAmount = (numberOfMonths * monthPay) ; 
...
calculateTotalMortgage(10,0,50000,'2020-04-15') 
calculateTotalMortgage(10,0,10000,  '2022-04-15')
